...
<ul class="resp-tabs-list">
    @foreach ($category_name as $key => $category_names)
    <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>Danh Mục {{$category_names->category_name}}</span></li> 
    @endforeach
</ul>
